...
| 首页 | 发现页 | 景点导航 |
|:---:|:---:|:---:|
| ![首页](scteenshots/01-login.png) | ![发现页](scteenshots/02-login.png) | ![景点导航](scteenshots/03-login.png) |
| 景区推荐、热门景点、旅游攻略入口 | 最新攻略、出行贴士、景区公告、民族文化 | 实时定位、路线规划、距离计算、导航指引 |

| 个人中心 | 酒店入住信息 | 付款信息 |
|:---:|:---:|:---:|
| ![个人中心](scteenshots/05-login.png) | ![酒店入住信息](scteenshots/06-login.png) | ![付款信息](scteenshots/07-login.png) |
| 我的订单、预订、收藏、浏览历史 | 房型选择、入住日期、住客信息填写 | 订单确认、金额明细、微信支付 |

| 支付完成 |
|:---:|
| ![支付完成](scteenshots/08-login.png) |
| 支付成功反馈，订单同步至后台管理系统 |
